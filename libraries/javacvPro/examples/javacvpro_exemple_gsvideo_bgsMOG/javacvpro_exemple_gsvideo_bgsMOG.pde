...
void setup(){ // fonction d'initialisation exécutée 1 fois au démarrage
	...
	cam1 = new GSCapture(this, widthCapture, heightCapture); // Initialise objet GSCapture désignant webcam
	...
	opencv = new OpenCV(this); // initialise objet OpenCV à partir du parent This
        ...
        opencv.bgsMOGInit(200, 5, 0.5, 10); // initialise bgsMOG avec paramètres voulus 
...
void  draw() { // fonction exécutée en boucle
  ...
  if (cam1.available() == true) { // si une nouvelle frame est disponible sur la webcam
    ...
    opencv.bgsMOGApply(opencv.Buffer, opencv.BufferGray, -1); // ajoute un frame à l'objet BackGround Subtractor MOG
