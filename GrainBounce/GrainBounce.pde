...
void setup()
{
  ...
  controlP5.addToggle("envelopeToggle", true, envelope.x, envelope.y - 22, 20, 20)
           .captionLabel().setVisible(false);
  controlP5.addRange("grainDuration", 100, 15000, lowDuration, highDuration, envelope.x, envelope.y + envelope.myHeight + 30, 100, 10)
           .setLabel("Grain Duration");
